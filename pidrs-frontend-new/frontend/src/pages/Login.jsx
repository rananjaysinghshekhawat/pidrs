...
const Login = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-14 px-6">
      <p className="text-xs text-ink/50 mb-2">Access · Citizen or Authority</p>
      <h2 className="font-display font-700 text-3xl text-ink mb-6">Log in</h2>
      ...
      <p className="text-sm mt-4 text-ink/60">
        No account yet? <Link to="/register" className="text-steel underline">Register</Link>
      </p>
    </div>
  );
};
